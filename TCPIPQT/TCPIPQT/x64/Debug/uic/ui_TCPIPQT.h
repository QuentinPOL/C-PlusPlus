...
public:
    ...
    void setupUi(QMainWindow *TCPIPQTClass)
    {
        ...
        label_status->setGeometry(QRect(360, 60, 181, 16));
    ...
    void retranslateUi(QMainWindow *TCPIPQTClass)
    {
        ...
        pushMessageButton->setText(QCoreApplication::translate("TCPIPQTClass", "Afficher le message", nullptr));
